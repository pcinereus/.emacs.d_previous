...
* Emacs Music Management
  #+BEGIN_SRC emacs-lisp
    ...
    (use-package emms
      ...
      :bind
      (
       (kbd "<S-kp-0>"). emms-pause)                  ; numeric keypad 1
       (kbd "<S-kp-subtract>") . emms-volume-lower)   ;numeric keypad -
       (kbd "<S-kp-add>") . emms-volume-raise)        ;numeric keypad +
    ...
    ;; (global-set-key (kbd "<S-kp-0>") 'emms-pause) ; numeric keypad 1
    ;; (global-set-key (kbd "<S-kp-subtract>") 'emms-volume-lower) ;numeric keypad -
    ;; (global-set-key (kbd "<S-kp-add>") 'emms-volume-raise) ;numeric keypad +
    ;; (global-set-key (kbd "<S-kp-multiply>") 'emms-playlist-mode-go)
