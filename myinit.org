...
* Hydra
  #+BEGIN_SRC emacs-lisp
    ...
    (use-package calfw
                 :ensure t
                 :init (require 'calfw-org)) ; for the org diary view (calfw package)
...
* Scrolling and cursors
  #+BEGIN_SRC emacs-lisp
    ...
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ;;The following indicates that font-locking should wait a second when scrolling before applying font changes
    ;; apparently it speeds up scrolling..
    ;; http://tsengf.blogspot.com.au/2012/11/slow-scrolling-speed-in-emacs.html
    ;;(setq jit-lock-defer-time 1)
  #+END_SRC

  #+BEGIN_SRC emacs-lisp
    ;;To have the cursor centered vertically within a window
    ;;(add-to-list 'load-path "~/.emacs.d/elpa/centered-cursor-mode-20150420.1942")
...
* Auto-completion
  #+BEGIN_SRC emacs-lisp
    ;; Start of the auto-completion for
    ;; R========================================
    ...
    ;;remove the following line to see if it is responsible for the freezing issue
    ;;(add-to-list 'ac-dictionary-directories "~/.emacs.d/elpa/auto-complete-20150408.1132/dict")
    (ac-config-default)

    ;;turn the following off, as it freezes R
    ;;(require 'ac-R)
    ;;End of the auto-completion for R=======================================
...
* Key bindings
  #+BEGIN_SRC emacs-lisp
    ...
    (global-set-key (kbd "C-c c") 'org-capture) ; start capture mode
    ...
    (global-set-key [f6] 'ess-rdired)
    ;;(global-set-key [f7] 'ess-eval-chunk)
    (global-set-key [f7] 'eval-chunk)
    (global-set-key (kbd "S-TAB") 'markdown-cycle)
    (global-unset-key [f2 f2])
    (global-set-key [C-f1] 'framepop-toggle-frame)
    ...
    ;;Turn off the annoying system bell or beep
    (setq visible-bell t)
...
* Custom variables
  #+BEGIN_SRC emacs-lisp
    (custom-set-variables
     ...
     '(bmkp-last-as-first-bookmark-file "/home/murray/.emacs.d/bookmarks")
     '(custom-safe-themes
		(quote
			    ("8db4b03b9ae654d4a57804286eb3e332725c84d7cdab38463cb6b97d5762ad26" "20e359ef1818a838aff271a72f0f689f5551a27704bf1c9469a5c2657b417e6c" "8aebf25556399b58091e533e455dd50a6a9cba958cc4ebb0aab175863c25b9a4" default)))
     '(ecb-layout-window-sizes
       (quote
     (("left8"
       (ecb-directories-buffer-name 0.2 . 0.2898550724637681)
       (ecb-sources-buffer-name 0.2 . 0.2318840579710145)
       (ecb-methods-buffer-name 0.2 . 0.2898550724637681)
       (ecb-history-buffer-name 0.2 . 0.17391304347826086)))))
     ...
     '(grep-find-command
       (quote
     ("find . -name '' -type f -exec grep -nH -e '' {} +" . 15)))
     '(org-export-html-extension "html")
     '(org-export-html-postamble-format (quote (("en" ""))))
     '(org-export-html-preamble "")
     '(org-export-htmlize-output-type (quote css)))
...
* IDO mode
  #+BEGIN_SRC emacs-lisp
    ...
    (ido-mode t) 
  #+END_SRC
* Emacs Music Management
  #+BEGIN_SRC emacs-lisp
    ;; Emacs music management system
    (use-package emms
                 :ensure t
                 :config
                   (progn
                     ...
                     (setq emms-info-asynchronously t
                           ...
                           ;;emms-source-file-directory-tree-internal "~/Music/"
                           emms-play-directory-tree "~/Music/"
                           ;;emms-source-file-directory-tree "~/Music"
                           emms-source-file-directory-tree-find "~/Music/"
                 ...
                 :bind
                   (
                    ("S-<kp-0>" . emms-pause)
                    ;;("S-<kp-subtract>") . emms-volume-mode-minus)   ;numeric keypad -
                    ;;(kbd "<S-kp-add>") . emms-volume-mode-plus)        ;numeric keypad +
                    ;;(kbd "<S-kp-multiply>") . emms-playlist-mode-go)
                    )
...
* Ace-jump-mode
  #+BEGIN_SRC emacs-lisp
    ;; ace-jump-mode (jumping around in buffers, between windows etc
    (autoload
      'ace-jump-mode
      "ace-jump-mode"
...
* Rebox
  #+BEGIN_SRC emacs-lisp
    ;; For putting fences around header info or comments
    ;;(add-to-list 'load-path "~/.emacs.d/elpa/rebox2-20121113.500")
    (use-package rebox2
	:ensure t)
...
* Calendar
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    ;;           :ensure t
    ;;           :config
    ;;           (setq org-gcal-client-id "418192318291-4jn5kpplepurelu8dn2o1qlmh89eulvb.apps.googleusercontent.com"
    ;;                 org-gcal-client-secret "nrfX0nVn4uqzoD3CEjy390ft"
    ;;                 org-gcal-file-alist '(("i.obesulus@gmail.com" .  "~/Dropbox/org/gcal.org"))))

    ;; ;;sync to google calendar when load agenda
    ;; (add-hook 'org-agenda-mode-hook (lambda () (org-gcal-sync) ))
    ;; ;;sync to google calendar when I capture
...
* PDF tools
  #+BEGIN_SRC emacs-lisp
  ;;pdf-tools (a complete replacement for dov-view for PDF)
    ;; has brilliant editing etc
...
* Regexp builder
  #+BEGIN_SRC emacs-lisp
  ;; The following defines a useful function for using the current re-builder rexexp
    ;; in a query-replace-regexp
...
* Outline mode
  #+BEGIN_SRC emacs-lisp
    ...
    (let ((map outline-mode-map))
      (define-key map (kbd "<C-s-left>") 'outline-hide-more)
      (define-key map (kbd "<C-s-right>") 'outline-show-more)
      (define-key map (kbd "C-s-<up>") 'outline-previous-visible-heading)
      (define-key map (kbd "C-s-<down>") 'outline-next-visible-heading)
    ...
    ;;;;;;;;;;;;;;;;END of outline mode modifications;;;;;;;;;;;;;;;;;;;;;;;;
...
* Multiple search and replace
  #+BEGIN_SRC emacs-lisp
      ;; Perform multiple search and replace pairs
    (use-package cl
	:ensure t)
...
* Bookmark
  ...
  (global-set-key (kbd "<C-f8>")   'bm-show-all)
